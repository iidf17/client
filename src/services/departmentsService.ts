...
export const addDepartments = createAsyncThunk<Array<Department>, AddDepartmentRequestDto, AsyncThunkOptions>(
    `${NAMESPACE}/addDepartments`,
    async(addDepartmentData, {rejectWithValue}) => {
        try {
            DepartmentsApi().addDepartment(addDepartmentData);
            return await DepartmentsApi().getDepartments();
        } catch(error) {
            return rejectWithValue((error as Error).message);
        }
...
export const editDepartments = createAsyncThunk<Array<Department>, EditDepartmentResponseDto, AsyncThunkOptions>(
    `${NAMESPACE}/editDepartments`,
    async(editDepartmentData, {rejectWithValue}) => {
        try {
            DepartmentsApi().editDepartment(editDepartmentData);
            return await DepartmentsApi().getDepartments();
        } catch(error) {
            return rejectWithValue((error as Error).message);
        }
...
export const deleteDepartments = createAsyncThunk<Array<Department>, string | number, AsyncThunkOptions>(
    `${NAMESPACE}/deleteDepartments`,
...
export const addEmployee = createAsyncThunk<Array<Department>, AddEmployeeResponseDto, AsyncThunkOptions>(
    ...
    async(addEmployeeData, {rejectWithValue}) => {
        try {
            EmployeeApi().addEmployee(addEmployeeData);
            return await DepartmentsApi().getDepartments();
        } catch(error) {
            return rejectWithValue((error as Error).message);
        }
...
export const editEmployee = createAsyncThunk<Array<Department>, UpdateEmployeeResponseDto, AsyncThunkOptions>(
    ...
    async(editEmployeeData, {rejectWithValue}) => {
        try {
            EmployeeApi().editEmployee(editEmployeeData);
            return await DepartmentsApi().getDepartments();
        } catch(error) {
            return rejectWithValue((error as Error).message);
        }
...
export const addEducation = createAsyncThunk<Array<Department>, AddEducationResponseDto, AsyncThunkOptions>(
    ...
    async(addEducationData, {rejectWithValue}) => {
        try {
            EmployeeApi().addEducation(addEducationData);
            return await DepartmentsApi().getDepartments();
        } catch(error) {
            return rejectWithValue((error as Error).message);
        }
...
export const deleteEducation = createAsyncThunk<Array<Department>, string | number, AsyncThunkOptions>(
    ...
    async(id, {rejectWithValue}) => {
        try {
            EmployeeApi().deleteEducation(id);
            return await DepartmentsApi().getDepartments();
        } catch(error) {
            return rejectWithValue((error as Error).message);
        }
...
export const addWorkExperience = createAsyncThunk<Array<Department>, AddWorkExperienceResponseDto, AsyncThunkOptions>(
    ...
    async(addWorkExperienceData, {rejectWithValue}) => {
        try {
            EmployeeApi().addWorkExperience(addWorkExperienceData);
            return await DepartmentsApi().getDepartments();
        } catch(error) {
            return rejectWithValue((error as Error).message);
        }
...
export const deleteWorkExperience = createAsyncThunk<Array<Department>, string | number, AsyncThunkOptions>(
    ...
    async(id, {rejectWithValue}) => {
        try {
            EmployeeApi().deleteWorkExperience(id);
            return await DepartmentsApi().getDepartments();
        } catch(error) {
            return rejectWithValue((error as Error).message);
        }
